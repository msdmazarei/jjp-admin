export const fa = {
    ...
    msg: {
        ui: {
            ...
            msg5: 'خطا رخ داد مجددا تلاش کنید.',
    ...
    permissions_list: {
        ...
        ACCOUNT_GET_PREMIUM : 'دسترسی به لیست حساب های اعتباری بدون محدودیت',
    
        LIBRARY_ADD_PREMIUM : 'افزودن کتابخانه بدون محدودیت',
        LIBRARY_EDIT_PREMIUM : 'ویرایش کتابخانه بدون محدودیت',
        LIBRARY_DELETE_PREMIUM : 'حذف کتابخانه بدون محدودیت',
        LIBRARY_GET_PREMIUM : 'دسترسی به لیست کتابخانه بدون محدودیت',
