export const fa = {
    ...
    dashboard:"پیشخوان",
    genre_option_comedy:"کمدی",
    genre_option_drama:"درام",
    genre_option_romance:"رمان",
    genre_option_social:"اجتماعی",
    genre_option_religious:"دینی",
    genre_option_historical:"تاریخی",
    genre_option_classic:"کلاسیک",
    genre_option_science:"علمی",
    book_type_list:{
        DVD: 'DVD',
        Audio: 'Audio',
        Hard_Copy: 'Hard_Copy',
