        ...
        },
        {
          ...
          templateFunc: () => {
            return <>
              ...
              {
                (this.is_this_sort_exsit_in_state(SORT.pub_year) === false && this.is_this_sort_exsit_in_state(SORT.pub_year_) === false)
                  ?
                  <span
                    className="btn btn-sm my-0 py-0 sort-btn-icon-wrapper"
                    onClick={() => this.sort_handler_func(SORT.pub_year, SORT.pub_year_, true, 1)}
                  ...
                  :
                  this.is_this_sort_exsit_in_state(SORT.pub_year) === true
                    ?
                    <span className="btn btn-sm my-0 py-0 sort-btn-icon-wrapper"
                      onClick={() => this.sort_handler_func(SORT.pub_year_, SORT.pub_year, false, 0)}
                      onMouseOver={() => this.sort_icon_change_on_mouse_over_out('pub_year', true)}
                      onMouseOut={() => this.sort_icon_change_on_mouse_over_out('pub_year', false)}>
                    ...
                    :
                    this.is_this_sort_exsit_in_state(SORT.pub_year_) === true
                      ?
                      <span className="btn btn-sm my-0 py-0 sort-btn-icon-wrapper"
                        onClick={() => this.sort_handler_func(SORT.pub_year_, SORT.pub_year, true, 2)}
                        onMouseOver={() => this.sort_icon_change_on_mouse_over_out('pub_year', true)}
                        onMouseOut={() => this.sort_icon_change_on_mouse_over_out('pub_year', false)}>
