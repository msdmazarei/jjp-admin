...
class BookSaveComponent extends BaseComponent<IProps, IState> {
    ...
    typeOptions = [
        ...
        { value: 'Hard_Copy', label: 'Hard_Copy' },
        { value: 'Pdf', label: 'Pdf' },
    ...
    async create() {
        ...
        let res = await this._bookService.addBook(newBook).catch(error => {
            this.handleError({ error: error });
        });
        this.setState({ ...this.state, createLoader: false });
                    ...
                    <div className="row">
                        <div className="col-12">
                            ...
                            <div className="d-flex justify-content-between mt-4">
                                <div className="mr-0 pr-0">
                                    {
                                        this.state.saveMode === SAVE_MODE.CREATE
                                            ...
                                            <>
                                                ...
                                                <BtnLoader
                                                    btnClassName="btn btn-warning  ml-2"
                                                    loading={false}
                                            ...
                                            :
                                            <BtnLoader
                                                btnClassName="btn btn-info ml-4"
                                ...
                                <BtnLoader
                                    btnClassName="btn btn-primary mr-4"
                                    loading={false}
                                    onClick={() => this.backTO()}
                                    disabled={false}
                                >
