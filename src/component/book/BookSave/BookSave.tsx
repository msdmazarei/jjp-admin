...
class BookSaveComponent extends BaseComponent<IProps, IState> {
    ...
    async update() {
        ...
        const newBook = {
            ...
            pages: this.state.book.pages.value,
            duration: this.state.book.duration.value,
            from_editor: this.state.book.from_editor.value === null ? undefined : this.state.book.from_editor.value,
            description: this.state.book.description.value === null ? undefined : this.state.book.description.value,
